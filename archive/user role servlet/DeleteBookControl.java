...
public class DeleteBookControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            boolean result = new BookDAO().deleteBook(id);
            if (result) {
                 request.setAttribute("delete_message", "Delete book successfully!");
            }else {
                 request.setAttribute("delete_message", "Delete book fail!");
            }
